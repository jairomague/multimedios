    ...
    if(datos.code == 200) {
        ...
        >
            <button
                ...
                aria-label="Close"
            ></button>
            <strong>Error al registrar profesor</strong>
        </div>`
    }
    limpiarForm();
    ...
    if(datos.code == 200) {
        ...
        >
            <button
                ...
                aria-label="Close"
            ></button>
            <strong>Borrado de profesor exitoso</strong>
        </div>`;
        ...
        >
            <button
                ...
                aria-label="Close"
            ></button>
            <strong>Error al borrar profesor</strong>
        </div>`
    }
    setTimeout(cerrarMensaje, 2500);
}
    ...
    if(datos.code == 200) {
        ...
        >
            <button
                ...
                aria-label="Close"
            ></button>
            <strong>Error al actualizar profesor</strong>
        </div>`
    }
    setTimeout(cerrarMensaje, 2500);
}
